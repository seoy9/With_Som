...
class NoticeActivity : AppCompatActivity() {
    ...
    private fun initRecycler() {
        ...
        notices.apply {
            add(NoticeData("1", "[첫 공지] With Som 서비스가 시작되었습니다!", "2022-10-21", "안녕하세요. :) 개발자 홍서연입니다.\nWith Som 서비스가 드디어 시작되었습니다!\n많은 이용 부탁드립니다."))
            add(NoticeData("2", "[업데이트 공지] 10/24 With Som 업데이트", "2022-10-24", "안녕하세요. With Som 개발자입니다.\n모임 상세 정보, 설정 페이지가 생성되었습니다."))
            add(NoticeData("3", "[업데이트 공지] 10/25 With Som 업데이트", "2022-10-25", "안녕하세요. With Som 개발자입니다.\n메인 공지 자동스크롤, 검색, 모임 상세 정보, 공지 페이지가 생성되었습니다."))
