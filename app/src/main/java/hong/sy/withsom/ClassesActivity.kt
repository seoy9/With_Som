...
class ClassesActivity : AppCompatActivity() {
    ...
    private fun initRecycler() {
        ...
        datas.apply {
            add(ClassData(R.drawable.foundation, "20221234 이솜솜", "솜솜덕질", "취미", "솜솜이를 덕질해보자!"))
            add(ClassData(R.drawable.simbol, "20225678 김솜솜", "정보처리기사", "자격증", "컴퓨터학과 졸업요건 달성"))
            add(ClassData(R.drawable.vision, "20229000 박솜솜", "만 보 걷기", "운동", "건강해지자!!"))
